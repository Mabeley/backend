...
class TestConfiguracion(unittest.TestCase):
    def setUp(self):
        #en vez del constructor en las clases comunes y corrientes
        #en los test se utiliza el metodo SetUp que servira para configurar todas 
        #los atributos y demas cosas que vallamos a utilizar en los escenarios
        #de test de esta clase (metodos)
        self.nombre = 'Eduardo'
    ...
    @unittest.skip('lo salte porque solamente queria saber el funcionamiento del metodo setup')
    def testNombre(self):
...
#CON ESTO SE CORRE
#python -m unittest test_inicio_flask.py -v