...
SECRET_KEY = 'django-insecure-i^62np9d(t&a%%kw0^299rs=j%t$l5pe7$$hg2w37ipjs+^hpa'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',#postgresql || sqlite ||oracle
        'NAME': environ.get('DATABASE_NAME'), #nombre de la bd
        'USER' : environ.get('DATABASE_USER'), #usuario de la bd
...
#sera la ruta por la cual se podra devolver todos los archivos multimedias
#de el proyecto
MEDIA_URL ='/archivos/'
