...
class UserManager(BaseUserManager):
    """Clase que sirve para menejar el comportamiento del auth_user"""
    def create_user(self, correo,nombre, rol, password):
        ...
        #normalizo el correo > aparte de validar que sea un correo valido removera
    ...
    def create_superuser(self, correo,nombre,rol,password):
        """Creacion de un super usuario por consola, este metodo se mandara a llamar cuando s
        se haga el uso del comando por la consola"""
        usuario= self.create_user(correo, nombre, rol, password)
        #is_superuser > indicara que usuarios son super usuarios y podra acceder a todas 
        #las funcionalidades del panel administrativo
